...
#TODO: aby fungovalo s jinymi hodnotami float_parts
...
def string_test():
    ...
    codew_p_frame,codew_p_last_frame = encode_bch_dwt(vid_path, message, xor_key,flag_delete_dirs=False, string_flag=True, bch_num=num)

    vid_sec = r"video.avi"
    outp_path = r"decoded.txt"
    
    
    decode_bch_dwt(vid_sec, codew_p_frame,codew_p_last_frame, xor_key,outp_path,flag_recostr_vid=False, string_flag=True, bch_num=num)
...
def file_test():
    ...
    num = 5
    vid_path = r"data_testing\input_video.mp4"
    codew_p_frame,codew_p_last_frame = encode_bch_dwt(vid_path, path, xor_key,flag_delete_dirs=False, bch_num=num)

    vid_sec = r"video.avi"
    outp_path = r"decoded.txt"
    decode_bch_dwt(vid_sec, codew_p_frame,codew_p_last_frame, xor_key,outp_path,flag_recostr_vid=False, bch_num=num)
