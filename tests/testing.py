...
if __name__ == "__main__":
    ...
    if flag == 1:
        ...
        hmc.hamming_encode(video_path,message_png_file, key_1, key_2, key_3, shuffle_flag = shuffle, flag_delete_dirs = recontructed_vid)
        
    elif flag == 2:
        #dekodovani souboru z videa (zde png)
        
        message_len_file = len(bnr.file_to_binary_1D_arr(message_png_file))
        hmc.hamming_decode(stego_video_path, key_1, key_2, key_3, message_len_file, output_path_png, shuffle_flag = shuffle, flag_recostr_vid = recontructed_vid)
    ...
    #STRING
        ...
        hmc.hamming_encode(video_path,message_text_string, key_1, key_2, key_3, string_flag = True, shuffle_flag = shuffle,flag_delete_dirs = recontructed_vid)
